...
<head>
    ...
    <title>Magic Link - Flight Shield</title>
    <style>
...
<body>
    <div class="shield-card">
        <div class="shield-header">
            ...
            <div class="shield-subtitle">Magic Link Login</div>
        </div>
        ...
        <p class="shield-info">Enter your email address and we'll send you a login link.</p>
        ...
        <form method="post" action="/auth/magic-link">
            ...
            <button type="submit" class="shield-btn">Send Magic Link</button>
        </form>
