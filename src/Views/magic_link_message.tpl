...
<head>
    ...
    <title>Check Your Email - Flight Shield</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .shield-message {
            ...
            color: #2d6a2d; padding: 1rem; margin-bottom: 1.5rem; font-size: 0.875rem;
            text-align: center;
        }
        .shield-links { text-align: center; font-size: 0.875rem; }
...
<body>
    <div class="shield-card">
        <div class="shield-header">
            ...
            <div class="shield-subtitle">Check Your Email</div>
        </div>

        <div class="shield-message">
            If an account with that email exists, a magic link has been sent. Please check your inbox and click the link to sign in.
        </div>
