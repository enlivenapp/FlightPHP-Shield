                ...
                <table width="420" cellpadding="0" cellspacing="0" style="background: #fff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="margin: 0 0 10px; color: #1a1a2e; font-size: 18px;">Your Login Link</h2>
                            <p style="color: #555; font-size: 14px; line-height: 1.6; margin: 0 0 20px;">Click the button below to sign in:</p>
                            <div style="text-align: center; margin-bottom: 20px;">
                                <a href="<?= htmlspecialchars($magicLinkUrl ?? '') ?>" style="display: inline-block; padding: 12px 30px; background: linear-gradient(135deg, #0f3460, #1a1a2e); color: #fff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600;">Sign In</a>
                            </div>
                            <p style="color: #555; font-size: 14px; line-height: 1.6; margin: 0 0 10px;">Or copy this link into your browser:</p>
                            <p style="color: #0f3460; font-size: 12px; word-break: break-all; margin: 0 0 20px;"><?= htmlspecialchars($magicLinkUrl ?? '') ?></p>
                            <p style="color: #555; font-size: 14px; line-height: 1.6; margin: 0;">This link will expire in one hour. If you did not request this, please ignore this email.</p>
                        </td>
                    </tr>
                    <tr>
